...
function doPost(e) {
  try {
    ...
    try {
      ...
      var tagPass = function(t) { return "<strong style='color:#1E8E3E;background:#E8F8EE;padding:2px 8px;border-radius:6px;font-size:12.5px;display:inline-block;'>" + t + "</strong>"; };
      var tagFail = function(t) { return "<strong style='color:#D70015;background:#FFF0F0;padding:2px 8px;border-radius:6px;font-size:12.5px;display:inline-block;'>" + t + "</strong>"; };
      var tagWarn = function(t) { return "<strong style='color:#E37400;background:#FFF6E6;padding:2px 8px;border-radius:6px;font-size:12.5px;display:inline-block;'>" + t + "</strong>"; };
      ...
      var htmlBody = "<div style='font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,sans-serif;max-width:650px;margin:0 auto;background:#F5F5F7;padding:20px;color:#1D1D1F;'>"
                   ...
                   + "<tr><td style='width:45%;color:#6E6E73;'>Display Power / Working</td><td>" + (row.display_working === "YES" ? tagPass("✅ Working (Clear)") : tagFail("❌ Fault / Blackout")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Touchscreen Response</td><td>" + (row.touchscreen_working === "YES" ? tagPass("✅ Responsive") : tagFail("❌ Faulty")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Front Screen Glass</td><td>" + (row.screen_cracked === "NO" ? tagPass("✅ Intact (No Cracks)") : tagFail("❌ Glass Cracked")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Screen Scratch Level</td><td>" + (row.screen_major_scratches && row.screen_major_scratches.indexOf("Heavy") !== -1 ? tagFail(row.screen_major_scratches) : (row.screen_major_scratches && row.screen_major_scratches.indexOf("Minor") !== -1 ? tagFail(row.screen_major_scratches) : tagPass("✅ Scratch-Free"))) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Lines / Dots / Spots</td><td>" + (row.display_lines_spots === "NO" ? tagPass("✅ Clean (No Defects)") : tagFail("❌ Defect Present")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Display Originality</td><td>" + (row.original_display === "YES" ? tagPass("✅ Original Apple Screen") : tagWarn("⚠️ Replaced Screen")) + "</td></tr>"
                   + "</table>"
                   + "</div>"
                   ...
                   + "<table style='width:100%;font-size:13px;line-height:1.9;border-collapse:collapse;'>"
                   + "<tr><td style='width:45%;color:#6E6E73;'>Metal Frame Marks</td><td>" + (row.body_condition && row.body_condition.indexOf("Clean") !== -1 ? tagPass("✅ Clean Metal Frame") : tagFail("❌ Has Dents / Body Scratches")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Chassis / Bent Body</td><td>" + (row.phone_bent === "NO" ? tagPass("✅ Flat &amp; Straight") : tagFail("❌ Frame Bent / Curved")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Back Glass Condition</td><td>" + (row.body_damage === "NO" ? tagPass("✅ Intact") : tagFail("❌ Back Glass Broken")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Camera Lens Glass</td><td>" + (row.camera_glass_condition === "NO" ? tagPass("✅ Clear &amp; Intact") : tagFail("❌ Glass Broken")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Parts / Screws</td><td>" + (row.missing_parts === "NO" ? tagPass("✅ All Intact") : tagFail("❌ Missing Parts")) + "</td></tr>"
                   + "</table>"
                   + "</div>"
                   ...
                   + "<table style='width:100%;font-size:13px;line-height:1.9;border-collapse:collapse;'>"
                   + "<tr><td style='width:45%;color:#6E6E73;'>Front Camera</td><td>" + (row.front_camera === "YES" ? tagPass("✅ Working") : tagFail("❌ Faulty")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Rear Main Camera</td><td>" + (row.rear_camera === "YES" ? tagPass("✅ Working") : tagFail("❌ Faulty")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Camera Flash</td><td>" + (row.camera_flash === "YES" ? tagPass("✅ Working") : tagFail("❌ Faulty")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Face ID / Biometrics</td><td>" + (row.face_id_touch_id === "YES" ? tagPass("✅ Working") : tagFail("❌ Broken")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Charging Port</td><td>" + (row.charging_port === "YES" ? tagPass("✅ Port &amp; Fast Charge OK") : tagFail("❌ Port Issue")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Speaker &amp; Audio</td><td>" + (row.speaker === "YES" ? tagPass("✅ Loudspeaker OK") : tagFail("❌ Audio Issue")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Earpiece / Receiver</td><td>" + (row.ear_receiver === "YES" ? tagPass("✅ Clear Call Audio") : tagFail("❌ Receiver Issue")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Microphone</td><td>" + (row.microphone === "YES" ? tagPass("✅ Working") : tagFail("❌ Faulty")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Physical Buttons</td><td>" + (row.power_button === "YES" && row.volume_buttons === "YES" ? tagPass("✅ Power &amp; Volume OK") : tagFail("❌ Button Issue")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Silent Switch</td><td>" + (row.silent_switch === "YES" ? tagPass("✅ Working") : tagFail("❌ Faulty")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Wi-Fi &amp; Bluetooth</td><td>" + (row.wifi === "YES" && row.bluetooth === "YES" ? tagPass("✅ Connected OK") : tagFail("❌ Wireless Issue")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Mobile SIM / Network</td><td>" + (row.mobile_network_sim === "YES" ? tagPass("✅ Signal OK") : tagFail("❌ Network Issue")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>GPS Location</td><td>" + (row.gps === "YES" ? tagPass("✅ Working") : tagFail("❌ Faulty")) + "</td></tr>"
                   + "</table>"
                   + "</div>"
                   ...
                   + "<table style='width:100%;font-size:13px;line-height:1.9;border-collapse:collapse;'>"
                   + "<tr><td style='width:45%;color:#6E6E73;'>Battery Health</td><td>" + (row.battery_health && row.battery_health.indexOf("Above") !== -1 ? tagPass("🟢 " + row.battery_health) : tagFail("🔴 " + (row.battery_health || "Below 80%"))) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Liquid / Water Damage</td><td>" + (row.liquid_damage === "NO" ? tagPass("✅ Safe (No Water Damage)") : tagFail("❌ Liquid Damaged")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Component Repairs</td><td>" + (row.major_component_replaced === "NO" ? tagPass("✅ None (Original)") : tagWarn("⚠️ Replaced: " + (row.replaced_component || "Parts"))) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>Warranty Period</td><td><strong>" + (row.warranty_status || "6 to 11 Months") + "</strong></td></tr>"
                   + "<tr><td style='color:#6E6E73;'>📦 Original Box</td><td>" + (row.original_box === "YES" ? tagPass("✅ Available (YES)") : tagFail("❌ Missing (NO)")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>⚡ Original Charger / Cable</td><td>" + (row.original_cable_adapter === "YES" ? tagPass("✅ Available (YES)") : tagFail("❌ Missing (NO)")) + "</td></tr>"
                   + "<tr><td style='color:#6E6E73;'>🧾 Purchase Invoice / Bill</td><td>" + (row.original_bill === "YES" ? tagPass("✅ Available (YES)") : tagFail("❌ Missing (NO)")) + "</td></tr>"
                   + "</table>"
                   + "</div>"
                   ...
                   + (row.failed_test_names && row.failed_test_names !== "None" ? "<span style='color:#D70015;font-weight:700;margin-top:4px;display:inline-block;'>⚠️ " + row.failed_test_names + "</span>" : "<span style='color:#1E8E3E;font-weight:700;margin-top:4px;display:inline-block;'>✅ Clean Device (No Faults Reported)</span>")
                   + "</div>"
